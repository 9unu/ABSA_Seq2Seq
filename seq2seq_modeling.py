...
# 학습 데이터 만드는 class
    class TextStyleTransferDataset(Dataset):
        ...
        def __getitem__(self, index):
            ...
            encoder_text = f"토픽, 감성 태깅 :{sentence}"
...
if __name__ == "__main__":
    ...
    with_score_model=modeling(r'C:\Users\KHU\Desktop\tagging_seq2seq\sentenced_df_with_score.csv')
    with_score_model.save_model("with_score_model.pth")